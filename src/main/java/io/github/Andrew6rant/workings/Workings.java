...
public class Workings implements ModInitializer {
	...
	public void onInitialize() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Workings.STOP_SIGN, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Workings.DIAMOND_SIGN_SHOVEL, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Workings.DIAMOND_SIGN_FLAG, RenderLayer.getCutout());
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Workings.DIAMOND_SIGN_CROSS, RenderLayer.getCutout());
